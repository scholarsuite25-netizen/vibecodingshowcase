...
export const metadata: Metadata = {
  ...
  icons: {
    icon: '/Chrisland-Logo.jpeg',
    shortcut: '/Chrisland-Logo.jpeg',
    apple: '/Chrisland-Logo.jpeg',
  },
  openGraph: {
    ...
    images: [
      { 
        ...
        width: 512, 
        height: 512, 
        alt: 'Chrisland University AI Literacy, Vibe Coding & Web App Development Crest' 
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        <link rel="apple-touch-icon" href="/Chrisland-Logo.jpeg" />
      </head>
