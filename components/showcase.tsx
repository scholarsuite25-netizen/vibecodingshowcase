    ...
    <div className="relative min-h-screen bg-[#07090e] text-slate-100 flex flex-col font-sans selection:bg-[#B25900] selection:text-white bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(99,102,241,0.12),rgba(255,255,255,0))]">
          ...
          {isMobileMenuOpen && (
            ...
            >
              ...
              <div className="flex items-center gap-2.5 px-1 py-1">
                <div className="w-8 h-8 rounded-xl bg-[#0f1422] flex items-center justify-center p-0.5 shadow-md shadow-black/40 overflow-hidden flex-shrink-0 border border-white/20">
                  <Image 
                    src="/Chrisland-Logo.jpeg" 
                    alt="Chrisland Logo" 
                    width={28} 
          ...
          <div className="max-w-2xl flex flex-col justify-between text-center lg:text-left">
            <div>
              <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full text-xs font-semibold bg-white/[0.06] text-amber-300 border border-amber-500/30 mb-4 shadow-sm">
                <div className="w-4 h-4 rounded-full bg-[#0f1422] border border-white/20 flex items-center justify-center p-0.5 overflow-hidden flex-shrink-0">
                  <Image src="/Chrisland-Logo.jpeg" alt="Chrisland University Crest" width={14} height={14} referrerPolicy="no-referrer" className="object-contain" />
                </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="text-[11px] font-extrabold uppercase tracking-wider text-amber-400 flex items-center gap-2">
                  <div className="w-5 h-5 rounded-md bg-[#0f1422] border border-white/20 flex items-center justify-center p-0.5 overflow-hidden flex-shrink-0 shadow-sm">
                    <Image src="/Chrisland-Logo.jpeg" alt="Chrisland Crest" width={16} height={16} referrerPolicy="no-referrer" className="object-contain" />
                  </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/90 overflow-y-auto">
            ...
            >
              <div className="flex items-center justify-between border-b border-white/10 pb-3">
                <div className="flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-lg bg-[#0f1422] flex items-center justify-center p-0.5 shadow-sm overflow-hidden flex-shrink-0 border border-white/20">
                    <Image src="/Chrisland-Logo.jpeg" alt="Chrisland University Logo" width={26} height={26} referrerPolicy="no-referrer" className="object-contain" />
                  </div>
                  <div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/90 overflow-y-auto">
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-gradient-to-r from-amber-950/40 via-amber-900/20 to-transparent">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#0f1422] flex items-center justify-center p-1 shadow-md shadow-black/40 overflow-hidden flex-shrink-0 border border-white/20">
                    <Image src="/Chrisland-Logo.jpeg" alt="Chrisland Crest" width={32} height={32} referrerPolicy="no-referrer" className="object-contain" />
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
      ...
      <footer className="relative z-10 px-4 sm:px-8 lg:px-12 py-10 border-t border-white/10 bg-[#040609]">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6 text-xs text-slate-400">
          ...
          <div className="flex items-center gap-3.5">
            <div className="w-10 h-10 rounded-xl bg-[#0f1422] flex items-center justify-center p-1 shadow-md shadow-black/40 overflow-hidden flex-shrink-0 border border-white/20">
              <Image src="/Chrisland-Logo.jpeg" alt="Chrisland University Crest" width={36} height={36} referrerPolicy="no-referrer" className="object-contain" />
            </div>
            <div className="flex flex-col">
